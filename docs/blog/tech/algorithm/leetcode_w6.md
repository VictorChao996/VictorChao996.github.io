...
老實說目前分享的題目有不少都是大學時就寫過的, 有印象, 相對來說會比較容易寫, 等到我把看過的題目都寫完後, 才是真正的開始。 期待之後我仍能每週發文, 順利完成 [2024 年尾的 6 個月個人 & 職涯目標](../../growth/reflection/goal-setting/2024_6_month_goal.md) 中的 leetcode 目標, 那本週的分享就先到這, 下週繼續。
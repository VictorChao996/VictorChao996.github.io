...
## 緣起
根據之前的另一篇文章 [2024 年尾的 6 個月個人 & 職涯目標](../../growth/reflection/goal-setting/2024_6_month_goal.md) 中有提到其中一個職涯目標為刷 **leetcode**, 於是乎我就開了一個新的 repo 準備來練習題目, 目標是快速的寫過一遍 Blind 75 題目。
...
## 系列終點
還在思考為了這個短期的 [leetcode 目標](../../growth/reflection/goal-setting/2024_6_month_goal.md#職涯目標) 弄成 weekly updates 文章是否合理, 畢竟平常所剩時間已經不多, 有可能連每週寫三題的無法達成,。但個人還是希望說, 可以藉由輸出的方式強化輸入的內容, 這樣也能順便完成 [持續輸出](../../growth/reflection/goal-setting/2024_6_month_goal.md#職涯目標)這個目標。
